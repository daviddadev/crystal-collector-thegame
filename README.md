...
This project is part of my coding boot camp homework. Week 4 into the coding boot camp. Launch the game to see it in action.

Feel free to look at my projects. If you want to drop a line visit my personal [website](http://davidsoto.dev/).

## Launch

To see the project live tap [here](https://daviddadev.github.io/crystal-collector-thegame/index.html), and thanks for visiting my GitHub. Enjoy.
